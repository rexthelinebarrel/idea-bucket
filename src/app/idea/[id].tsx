...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 23, fontWeight: '700', color: colors.text, letterSpacing: 0.3 },
  time: { fontSize: 13, color: colors.textDim, marginTop: -8 },
  ...
  statusChipTextActive: { color: colors.accent, fontWeight: '600' },
  card: {
    backgroundColor: colors.card,
  ...
  cardTitle: { fontSize: 13, fontWeight: '600', color: colors.textDim, letterSpacing: 1 },
  playButton: {
    width: 46,
    height: 46,
    borderRadius: 23,
  ...
  sendButtonText: { color: colors.onAccent, fontWeight: '700', fontSize: 14 },
  connRow: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 8,
